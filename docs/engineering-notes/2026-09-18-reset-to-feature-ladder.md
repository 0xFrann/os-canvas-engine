...
[roadmap](../roadmap.md) is now a ladder of user-visible features. Each feature is designed only as
...
the first features of the ladder — this is what to expect, not a substitute for seeing it.
